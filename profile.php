...
if ($role == 'user') {
    ...
    $sql = "SELECT hospital.Name as HospitalName,users.VerifiedOn,users.PhoneNo,users.Username,users.Name,users.DOB,users.Gender,users.BloodType,users.Address FROM users left join hospital on users.VerifiedFrom=hospital.HospitalID WHERE users.Username = '$username'";
    $result = mysqli_query($con, $sql);
    if ($result && mysqli_num_rows($result) > 0) {
...
} elseif ($role == 'superuser' || $role == 'admin') {
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo ($disease['HBV'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
                            <tr>
                                <th>HIV:</th>
                                <td>
                                    <?php echo ($disease['HIV'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
                            <tr>
                                <th>Hepatitis C Virus:</th>
                                <td>
                                    <?php echo ($disease['HCV'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
                            <tr>
                                <th>Hepatitis E Virus:</th>
                                <td>
                                    <?php echo ($disease['HEV'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
                            <tr>
                                <th>Human T-lymphotropic Virus:</th>
                                <td>
                                    <?php echo ($disease['HTV'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
                            <tr>
                                <th>Malaria:</th>
                                <td>
                                    <?php echo ($disease['Malaria'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
                            <tr>
                                <th>Active Tuberculosis:</th>
                                <td>
                                    <?php echo ($disease['TB'] == '1') ? 'Positive' : 'Negative' ?>
                                </td>
                            </tr>
...
<?php elseif ($role == 'superuser'): ?>
    <div class="w-full text-center">
        <h1 class="text-3xl mb-10">Superuser Profile</h1>
        <form action="classes/update.php" method="post" class="w-full grid grid-cols-2 gap-4">
            <div class="flex flex-col text-center col-span-2 md:col-span-1">
                <label for="Username" class="font-bold">Username</label>
                <input disabled class="rounded shadow-inner bg-red-900 p-2" type="text" name="Username" id="Username"
            ...
            <div class="flex flex-col text-center col-span-2 md:col-span-1">
                <label for="PhoneNo" class="font-bold">Phone</label>
                <input class="rounded shadow-inner bg-red-900 p-2" type="number" name="PhoneNo" id="PhoneNo"
                    value="<?php echo $user['PhoneNo']; ?>">
            </div>
...
<?php elseif ($role == 'admin'): ?>
    <div class="w-full text-center">
        <h1 class="text-3xl mb-10">Hospital Administrator Profile</h1>
        <form action="classes/update.php" method="post" class="w-full grid grid-cols-2 gap-4">
            <div class="flex flex-col text-center col-span-2 md:col-span-1">
                <label for="Username" class="font-bold">Username</label>
                <input disabled class="rounded shadow-inner bg-red-900 p-2" type="text" name="Username" id="Username"
            ...
            <div class="flex flex-col text-center col-span-2 md:col-span-1">
                <label for="HospitalName" class="font-bold">Hospital</label>
                <input disabled class="rounded shadow-inner bg-red-900 p-2" type="text" name="HospitalName"
                    id="HospitalName" value="<?php $sql = "SELECT * FROM hospital WHERE HospitalID = '$user[HospitalID]'";
                    $result = mysqli_query($con, $sql);
