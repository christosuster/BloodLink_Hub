                ...
                <table class=" table-auto tbl mx-auto lg:mx-0 lg:text-lg">
                    <tbody>
                        <tr>
                            <th>Date of Birth:</th>
                            <td>
                                <?php echo isset($userInfo['DOB']) ? $userInfo['DOB'] : 'Not Provided' ?>
                            </td>
                        </tr>
                        <tr>
                            <th>Gender:</th>
                            <td>
                                <?php echo isset($userInfo['Gender']) ? $userInfo['Gender'] : 'Not Provided' ?>
                            </td>
                        </tr>
                        <tr>
                            <th>Blood Type:</th>
                            <td>
                                <?php echo isset($userInfo['BloodType']) ? $userInfo['BloodType'] : 'Not Provided' ?>
                            </td>
                        </tr>
                        <tr>
                            <th>Location:</th>
                            <td>
                                <?php echo isset($userInfo['Address']) ? $userInfo['Address'] : 'Not Provided' ?>
                            </td>
                        </tr>
    ...
    <div class="card col-span-6 lg:col-span-3  flex flex-col items-center w-full ">
        ...
        <div class="h-[300px] overflow-y-auto w-full">
            ...
            <?php foreach ($donationApplication as $donation): ?>
                <div class="flex flex-col items-center w-full py-2 my-2 item ">
                    <div class="grid grid-cols-6  gap-4 w-full justify-center items-center">
                        <div class="col-span-5 flex flex-col ">
                            <h1 class="mb-2 text-sm mx-auto">
                                Needed On:
                                <?php echo $donation['NeededOn'] ?>
                            </h1>
                        ...
                        <form action="classes/unvolunteer.php" method="post">
                            ...
                            <button name="submit" type="submit"
                                class="col-span-1 border rounded-full shadow-lg w-10 h-10 mx-auto">
